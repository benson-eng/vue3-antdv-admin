...
const { t } = useI18n('routes.member.fixedVipMemberSettingPage');
...
const openModal = (mode: ModalMode, record?: FixedVipMemberInfo) => {
...
const onDelete = async (record: FixedVipMemberInfo) => {
